...
public class TwoPieceLeft extends AutoBase{
    ...
    PathPlannerTrajectory maderaPT1 = PathPlanner.loadPath("OnePieceRight", new PathConstraints(6, 3));
    PathPlannerTrajectory maderaPT2 = PathPlanner.loadPath("OnePieceRight PT2", new PathConstraints(6, 3));
    PathPlannerTrajectory maderaPT3 = PathPlanner.loadPath("OnePieceRight PT3", new PathConstraints(6, 6));
